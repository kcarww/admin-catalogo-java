...
public class CategoryTest {
    ...
    public void givenAnInvalidNullName_whenCallNewCategoryAndValidate_thenShouldReturnError() {
        ...
        final var actualException =
                Assertions.assertThrows(DomainException.class, () -> actualCategory.validate(new ThrowsValidationsHandler()));        Assertions.assertEquals(expectedErrorCount, actualException.getErrors().size());
    ...
    public void givenAnInvalidEmptyName_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        ...
        final var actualException =
                Assertions.assertThrows(DomainException.class, () -> actualCategory.validate(new ThrowsValidationsHandler()));
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenReturnCategoryInactivated() {
        ...
        Assertions.assertDoesNotThrow(() -> aCategory.validate(new ThrowsValidationsHandler()));
